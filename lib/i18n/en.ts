...
const en = {
  common: {
    ...
    statusCampaignEnded: "Campaign ended",
    statusCampaignPaused: "Campaign paused",
  ...
  brand: {
    ...
    viewsChartSubtitle: "Total verified views across every clip in this campaign.",
    viewsChartLabel: "views",
